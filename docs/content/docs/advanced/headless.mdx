...
<Cards>
  ...
  <Card title="💡 Examples" href="/configuration/basic" description="More examples" />
  <Card title="🎨 Theming" href="/configuration/theming" description="Styling the full component" />
</Cards>
