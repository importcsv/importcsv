...
- Custom `ThemeConfig` object (see [Theming Guide](/configuration/theming))
...
<Cards>
  <Card title="🎨 Headless Components" href="/advanced/headless" description="Build custom UI with primitives" />
  <Card title="🛡️ Zod Schemas" href="/configuration/schemas" description="Advanced validation patterns" />
  <Card title="📖 API Reference" href="/reference/api" description="Complete props documentation" />
  <Card title="💡 Examples" href="/configuration/basic" description="More advanced examples" />
</Cards>
