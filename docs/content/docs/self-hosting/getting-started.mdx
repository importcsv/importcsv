...
- [Admin Dashboard Guide](/self-hosting/admin-dashboard) - Learn about all dashboard features
- [API Reference](/self-hosting/api-reference) - Integrate with the API directly
- [Backend vs Cloud](/self-hosting/comparison) - Choose the right approach