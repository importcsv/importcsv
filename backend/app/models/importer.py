import uuid
from sqlalchemy import Column, Integer, String, JSON, DateTime, ForeignKey, UUID, Boolean
...
class Importer(Base):
    ...
    disable_on_invalid_rows = Column(Boolean, default=False)  # Disable importing all data if there are invalid rows
