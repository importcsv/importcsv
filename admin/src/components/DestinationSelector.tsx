...
export function DestinationSelector({
  ...
  const handleTableSelect = (
    ...
    onChange({
      ...
      // Reset column mapping when table changes
      columnMapping: {},
    });
  };
              ...
              <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-100">
                <div className="text-sm">
                  ...
                  <p className="text-blue-700">
                    {value.supabaseColumns.filter(c => !isAutoGeneratedColumn(c.column_name)).length} importable columns detected
                  </p>
                </div>
                <Button
                  type="button"
                  size="sm"
                  onClick={() => onImportSchema(value.supabaseColumns)}
                >
